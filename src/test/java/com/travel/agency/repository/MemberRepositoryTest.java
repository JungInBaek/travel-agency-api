...
class MemberRepositoryTest {
    ...
    void memberSaveTest() {
        // given
        Member member = Member.builder().id("baek").password("12345").name("백정인").ssn("960519-1111111").tel("010-1111-2222").email("baek@naver.com").postcode("45910").address("부산 해운대구 송정동").englishName("BJI").salt(EncryptionUtils.createSalt()).build();
